...
Kurv laver kassen i "constructor" og styrer flyttningen af kassen og tjekker om appelsinen bliver grabet 
*/
...
class Kurv {
    ...
    tegn() 
        ...
        image(Turban, this.x+1, this.y+5, this.bred-1, this.dyb-10);
