...
let yspeed = -10;
let newspeed;
const grav = 0.1; // acceleration i nedadgående retning, lige som tyngdekræft. Grav er en konsaten acceleration for bolden, virker lige som tyngdekraften. jo størrer jo hurtigerer bevægerer bolden sig ned af  
const col = [220,110,0];
...
// Øvrige
let tid = 150; // mængden af tid mellem bolde bliver kastet 
let score = 0;
let missed = 0;
let liv = 8;
